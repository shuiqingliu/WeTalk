...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [self.contentView addSubview:self.messageSendFailed];
        [self p_addMasonry];
    }
    return self;
}
...
- (void)messageSendFailedButtonDown:(UIButton *)sender{
    if (_delegate && [_delegate respondsToSelector:@selector(messageCellDidClickSendFailed:)]){
        [_delegate messageCellDidClickSendFailed:self.message];
    }
}
...
- (UIButton *)messageSendFailed{
    if (_messageSendFailed ==  nil) {
        _messageSendFailed = [[UIButton alloc] init];
        [_messageSendFailed.layer setMasksToBounds:YES];
        [_messageSendFailed setImage:[UIImage imageNamed:@"resend"] imageHL:[UIImage imageNamed:@"resend"]];
        [_messageSendFailed addTarget:self action:@selector(messageCellDidClickSendFailed::) forControlEvents:UIControlEventTouchUpInside];
    }
    return _messageSendFailed;
}
